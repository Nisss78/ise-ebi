...
- Name: landing.spec.ts >> ランディングページ >> ランディングページが正しく表示される
...
Locator: locator('h1')
Expected pattern: /クリエイター|ストア/
Received string:  "リンクも商品も1ページで売れる"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('h1')
    7 × locator resolved to <h1 class="text-3xl font-bold tracking-tight sm:text-5xl">…</h1>
      - unexpected value "リンクも商品も1ページで売れる"
