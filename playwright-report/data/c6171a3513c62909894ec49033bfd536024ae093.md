...
- Name: auth.spec.ts >> 認証フロー >> 登録ページが表示される
...
Locator: getByRole('heading', { name: /登録|サインアップ|Sign Up|Create/i }).or(locator('[data-testid=\'signup-form\'], form'))
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for getByRole('heading', { name: /登録|サインアップ|Sign Up|Create/i }).or(locator('[data-testid=\'signup-form\'], form'))
